...
import { TopBar } from "~/components/farcaster-demo/top-bar";
import { ActionList } from "~/components/farcaster-demo/action-list";
import { ActionDetail } from "~/components/farcaster-demo/action-detail";
import { WalletList } from "~/components/farcaster-demo/wallet-list";
import { WalletDetail } from "~/components/farcaster-demo/wallet-detail";
import { WalletConnectPrompt } from "~/components/farcaster-demo/wallet-connect-prompt";
import { ContextView } from "~/components/farcaster-demo/context-view";
import { BottomNavigation } from "~/components/farcaster-demo/bottom-navigation";
import {
  TabType,
  ActionPageType,
  WalletPageType,
