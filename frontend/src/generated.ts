...
export const leaderboardContractAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct LeaderboardContract.PlayerStats',
        type: 'tuple',
        components: [
          { name: 'visitCount', internalType: 'uint256', type: 'uint256' },
          { name: 'matchCount', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'homeOwner', internalType: 'address', type: 'address' },
      { name: 'visitor', internalType: 'address', type: 'address' },
    ],
    name: 'recordMatch',
    outputs: [],
    stateMutability: 'nonpayable',
